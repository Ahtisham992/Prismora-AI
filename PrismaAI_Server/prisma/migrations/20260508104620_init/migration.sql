...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'COMMENT', 'FOLLOW', 'COMMENT_LIKE');
...
-- AddForeignKey
ALTER TABLE "PostSummary" ADD CONSTRAINT "PostSummary_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
